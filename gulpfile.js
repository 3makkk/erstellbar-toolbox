    ...
    // Check for --env var
    var isProduction = (argv.env == 'production') || argv.production;
    ...
    var paths = {
        ...
        appJS: [
            'client/assets/js/config/' + env + '.js',
            'client/assets/js/app.js',
            'client/assets/js/node/**/*.js',
            'client/assets/js/user/**/*.js',
            'client/assets/js/toolbox/**/*.module.js',
            'client/assets/js/toolbox/**/*.js'
        ]
    };
    ...
    gulp.task('build', function(cb) {
        sequence('clean', ['lint', 'copy', 'copy:foundation', 'copy:fonts', 'sass', 'uglify'], 'copy:templates', 'minify-html', cb);
    });
